...
# from comicscantina.sitemaps import StaticViewSitemap
...
urlpatterns = [
    ...
    # # user's convinience.
    # url(r'^login/', RedirectView.as_view(pattern_name='comicscantina_login_master', permanent=True, query_string=True)),
    # url(r'^login', RedirectView.as_view(pattern_name='comicscantina_login_master', permanent=True, query_string=True)),
    # url(r'^sign-in/', RedirectView.as_view(pattern_name='comicscantina_login_master', permanent=True, query_string=True)),
    # url(r'^sign-in', RedirectView.as_view(pattern_name='comicscantina_login_master', permanent=True, query_string=True)),
