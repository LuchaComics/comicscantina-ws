...
def get_app_domain():
    ...
    """
    url = settings.COMICSCANTINA_APP_HTTP_PROTOCOL
    url += settings.COMICSCANTINA_APP_HTTP_DOMAIN
    return url
...
def tenant_url(schema_name, view_name):
    if schema_name:
        return settings.COMICSCANTINA_APP_HTTP_PROTOCOL + schema_name + '.%s' % settings.COMICSCANTINA_APP_HTTP_DOMAIN + reverse(view_name)
    else:
        return settings.COMICSCANTINA_APP_HTTP_PROTOCOL + '%s' % settings.COMICSCANTINA_APP_HTTP_DOMAIN + reverse(view_name)
